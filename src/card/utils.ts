...
export namespace CardUtils {
  ...
  export const getCardUrl = ({ cardNumber, packSetId }: { cardNumber: number; packSetId: string }): string => {
  ...
  export const getCardPath = ({ cardNumber, packSetId }: { cardNumber: number; packSetId: string }): Path => {
